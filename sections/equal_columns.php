...
<div class="colonnes_padding <?php if ($color) {
    echo 'color_' . $color;
} ?>   " <?php if($color AND $color == 'image') ?> style="background-image:url(<?php echo get_sub_field('background-image')['large']; ?>); background-size:cover; background-repeat:no-repeat">
	<div class="container">
		<div class="row">
